...
public class Configurations {
    ...
    public final static String XrayConfigPath = "./module-cb/src/test/java/com/bnpp/appium/xray/xray_config.properties";
    ...
    public final static String ReportConfigPath = "./module-cb/src/test/resources/CucumberReportSetup/reportconfig.properties";
