...
public class CucumberTest {
    ...
    public final static String PATH_REPORT_TEMPLATE;
    ...
    static {
        ...
        PATH_REPORT_TEMPLATE = com.bnpp.reportconfig.ReportPropertiesHandler.getTemplatePath();
    }
...
//            String deviceName = System.getProperty("devicename");
            String deviceName = "Samsung Galaxy S22 Ultra";
            LOGGER.info("deviceName from server is [" + deviceName + "]");
            if (!StringUtils.isEmpty(deviceName)) {
                DriverHolder.getInstance().init("./module-cb/src/test/resources/config/devices.json", deviceName);
            } else {
                throw new IllegalStateException("Cannot get the deviceName. Will quit");
            }

            PropertyLoader.getInstance().load("./module-cb/src/test/resources/config/testdata.properties");
        }
